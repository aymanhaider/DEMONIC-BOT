...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf DEMONIC-BOT && rm -rf .telegram-cli && git clone https://github.com/aymanhaider/DEMONIC-BOT.git && cd DEMONIC-BOT && ./launch.sh install && ./launch.sh
~~~~~
