...
git clone https://github.com/aymanhaider/DEMONIC-BOT.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf DEMONIC-BOT && rm -rf .telegram-cli && git clone https://github.com/aymanhaider/DEMONIC-BOT.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
